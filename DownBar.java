...
/* Andy, Zack, Shang-Lin
03/09/2018
This is the DownBar class. Creates lines that shrink from above. (shrinks down) It essentially works the same way as the RightBar class however has different math in the shrinkLines method (because of the direction). *refer to RightBar class */
